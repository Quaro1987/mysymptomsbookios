...
@synthesize userSymptomSpecialtiesArray, currentUser;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"symptomSpecialtyCell" forIndexPath:indexPath];
